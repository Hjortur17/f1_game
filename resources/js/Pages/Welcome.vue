...
<template>
    ...
    <header class="flex items-center justify-center">
        <div
            v-if="canLogin"
            class="absolute top-0 right-0 mx-auto hidden max-w-screen-xl px-12 py-6 sm:block"
        >
            <Link
        ...
        <div class="mx-auto max-w-screen-sm text-center">
            <h2 class="mb-4 text-5xl">Hallo heimur</h2>
            <p class="mb-8 text-lg">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab
                asperiores at aut autem consequatur est eum ex fugiat, in
                molestias non optio placeat quae quos tempore, tenetur ut
            ...
            >
                <Link
                    ...
                    >Join league</Link
                >
                <Link :href="route('login')" class="btn btn-grey btn-lg"
                    >Create league</Link
                >
            </div>

            <div class="flex w-full justify-center space-x-12" v-else>
                <Link :href="route('login')" class="btn btn-grey btn-lg"
                    >Login</Link
                >
                <Link
    ...
    <section class="bg-[#f0f4f8] py-24">
        <div class="mx-auto max-w-screen-lg p-4 pt-2">
            <div class="mb-36 w-1/2">
                <h3 class="mb-4 text-5xl">Rules of the game</h3>
                <p class="text-lg">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Aliquid aut consequatur eius fugiat id, illum ipsam
                    laudantium maiores nobis officia qui sed sequi suscipit
                    temporibus veniam. Cum possimus sequi voluptatum?
                </p>
            </div>
        </div>

        <div class="mx-auto grid max-w-screen-md grid-cols-3 gap-y-20">
            <div class="relative col-span-2">
                <h6
                    class="text-floating-left absolute overflow-hidden text-5xl text-[#D9E2EC]"
                    style=""
                >
                    01
                </h6>
                <h4 class="z-10 mb-2 text-4xl">Join a league</h4>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Accusantium incidunt optio quod sed voluptatum. Amet
                    consequatur doloribus ipsum iste labore laborum, natus quae
                    quis quo tempora velit veritatis vero, vitae!
                </p>
            </div>

            <div class="relative col-span-2 col-end-4 text-right">
                <h6
                    class="text-floating-right absolute overflow-hidden text-5xl text-[#D9E2EC]"
                    style=""
                >
                    02
                </h6>
                <h4 class="z-10 mb-2 text-4xl">Choose your drivers</h4>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Accusantium incidunt optio quod sed voluptatum. Amet
                    consequatur doloribus ipsum iste labore laborum, natus quae
            ...
            <div class="relative col-span-2">
                ...
                <h4 class="z-10 mb-2 text-4xl">Compete with your friends</h4>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Accusantium incidunt optio quod sed voluptatum. Amet
                    consequatur doloribus ipsum iste labore laborum, natus quae
    ...
    <footer class="mx-auto max-w-screen-lg pt-24 pb-10">© 2022</footer>

    <!--        <table class="w-full whitespace-nowrap -mt-16 shadow border-collapse rounded-2xl">-->
    <!--            <tbody>-->
    <!--            <tr class="bg-main-500 text-main-50 h-16">-->
    <!--                <th>Firstname</th>-->
    <!--                <th></th>-->
    <!--                <th>Age</th>-->
    <!--                <th>Age</th>-->
    ...
    <!--                <th>Age</th>-->
    <!--            </tr>-->
    <!--            <tr class="focus:outline-none h-16 rounded bg-white">-->
    <!--                <td class="">-->
